...
def chooseDeskOption():
    ...
    print ('You have been waiting for this all month.')
    print
    print
    print
    DeskOption = ''
    while DeskOption != 'Leave' and DeskOption != 'Check':
